          ...
          >
            <q-card class="card-bg text-white" bordered>
              <q-card-section class="text-h6 row justify-between">
                <div class="">
                  <div class="text-h6">ተጠጊ መዝግብ</div>
                </div>
              </q-card-section>
              ...
              <q-form @submit="onSubmit()">
                    ...
                    <q-item class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                      <q-item-section>
                        ...
                        outlined
                          ...
                          color="white"
                          dense
                          v-model="user_details.parent_prof"
                          label="የሚችሉት ሙያ(ትምህርት)(ልምድ)"
                          lazy-rules
                          :rules="[
                            (val) =>
                              (val && val.length > 0) ||
                    ...
                    <q-item class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                      <q-item-section>
                        <q-checkbox
                          ...
                          v-model="user_details.is_children"
                          label="ልጅ አለ"
                        />
                ...
                <q-card-section>
                  <hr style="width: 80%" />
                  <q-item-label class="q-px-xl text-center" >የልጆች መረጃ መሙያ</q-item-label>
                    ...
                    <q-item class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                      <q-item-section>
                        ...
                        outlined
                          ...
                          color="white"
                          dense
                          v-model="user_details.child_prof"
                          label="የሚችሉት ሙያ(ትምህርት)(ልምድ)"
                          lazy-rules
                          :rules="[
                            (val) =>
                    ...
                    <q-item class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                      <q-item-section>
                        <q-input
                          ...
                          outlined
                          type="textarea"
                          v-model="user_details.child_add"
                          label="ተጨማሪ"
